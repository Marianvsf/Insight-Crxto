                  ...
                  <form onSubmit={handleSupportSubmit} className="space-y-3">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-gray-50/50 border border-gray-200 rounded-lg text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 focus:bg-white transition-all"
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        ...
                        onChange={handleSupportChange}
                        rows={3}
                        className="w-full px-3 py-2 bg-gray-50/50 border border-gray-200 rounded-lg text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 focus:bg-white transition-all resize-none"
                      />
                    </div>
